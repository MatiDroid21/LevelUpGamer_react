...
export default function Perfil() {
    ...
    const calcularNivel = (puntos) => {
        if (puntos < 100) return { nivel: "Bronce", progreso: puntos, siguiente: 100, color: "#CD7F32" };
        if (puntos < 500) return { nivel: "Plata", progreso: puntos - 100, siguiente: 500, color: "#C0C0C0" };
        if (puntos < 1000) return { nivel: "Oro", progreso: puntos - 500, siguiente: 1000, color: "#FFD700" };
        if (puntos < 2500) return { nivel: "Platino", progreso: puntos - 1000, siguiente: 2500, color: "#E5E4E2" };
                        ...
                        <div className="card shadow-lg border-0 profile-card">
                            <div className="card-body text-center">
                                <div className="avatar-container mb-3">
                                    <i className="bi bi-person-circle" style={{ fontSize: "5rem", color: nivelInfo.color }}></i>
                                </div>
                                <h3 className="fw-bold">{usuario.nombre}</h3>
                                <p className="text-muted">{usuario.correo}</p>
                                
                                {/* Nivel y Puntos */}
                                <div className="nivel-badge my-3 p-3 rounded" style={{ backgroundColor: nivelInfo.color + "30", border: `2px solid ${nivelInfo.color}` }}>
                                ...
                                <div className="mt-4 p-3 bg-dark text-white rounded">
                                    ...
                                    <h5 className="mb-0 text-success">{usuario.codigoReferido || "LEVELUP" + usuario.nombre.substring(0, 3).toUpperCase()}</h5>
                                    <button 
                    ...
                    <div className="col-lg-8">
                        <div className="card shadow-lg border-0">
                            <div className="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                                <h4 className="mb-0"><i className="bi bi-gear-fill"></i> Mi Información</h4>
                                {!editMode && (
                                    <button 
                        ...
                        <div className="card shadow-lg border-0 mt-4">
                            <div className="card-header bg-primary text-white">
                                <h5 className="mb-0"><i className="bi bi-bag-check-fill"></i> Mis Compras</h5>
                            </div>
                            <div className="card-body">
