                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-12 mb-4">
                        ...
                        <ul className="list-unstyled footer-contact">
                            <li><i className="bi bi-envelope-fill me-2"></i> contacto@levelupgamer.cl</li>
                            <li><i className="bi bi-phone-fill me-2"></i> +56 9 9999 9999</li>
                            <li><i className="bi bi-truck me-2"></i> Envíos a todo Chile</li>
                        </ul>
                    </div>
                </div>
            </div>
